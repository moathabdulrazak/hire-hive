    ...
    <div className="footer">
      <div className="container">
        ...
        <div className="bottom">
          <div className="left">
            <h2>Hire Hive</h2>
            <span>© Hire Hive 2023</span>
          </div>
          <div className="right">
            <div className="social">
           <a href="https://www.linkedin.com/in/moathabdulrazak/" target="_blank"> <img  src="public\img\linkedin.png" alt="" /></a>   
            </div>
            <div className="social">
           <a href="https://github.com/moathabdulrazak" target="_blank"> <img  src="public\img\icons8-github-50.png" alt="" /></a>   
            </div>
            <div className="link">
